...
const LABELS: Record<string, string> = {
  ...
  hero_testimonial_author: 'Hero Testimonial Author Label',
  ...
  craft_box_title: 'Craft Image — Overlay Box Title',
  craft_box_subtitle: 'Craft Image — Overlay Box Subtitle',
  origin_box_title: 'Origin Image — Overlay Box Title',
  origin_box_subtitle: 'Origin Image — Overlay Box Subtitle',
  cta_title: 'CTA Title',
